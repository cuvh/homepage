    ...
    return (
        <DefaultLayout>
            ...
            <div className="container m-top-6 text-center">
                <div className="row">
                    <div className="col-sm-8 col-sm-offset-2 text-center">
                        <h4 className="m-bottom-12">Our values is what we are</h4>
                    </div>
                </div>
                <div className="row">
                    <div className="col-sm-6 col-md-5 col-md-offset-1">
                        <div className="about-value m-bottom-12">
                            ...
                            <h5 className="m-top-3 text-primary">A company of friends</h5>
                            <p className="m-top-2">
                                We have fun while working, often hang out together and go to the
                                seaside. Although sometimes the Atlantic separates us, we are always
                    ...
                    <div className="col-sm-6 col-md-5">
                        <div className="about-value m-bottom-12">
                            ...
                            <h5 className="m-top-3 text-primary">No to mediocrity</h5>
                            <p className="m-top-2">
                                Although we are young, we do things amazingly. If we don’t do well
                                at something, we admit the fact and find a way to make it shine.
                            </p>
                        </div>
                    </div>
                </div>
                <div className="row">
                    <div className="col-sm-6 col-md-5 col-md-offset-1">
                        <div className="about-value m-bottom-12">
                            ...
                            <h5 className="m-top-3 text-primary">User problems are a crisis</h5>
                            <p className="m-top-2">
                                We understand why user problems are a crisis, so you will never hear
                                us saying “Sorry for the inconvenience”. Our mission is to help
                                people, so it is a privilege to talk to you and solve the issue
                                together.
                            </p>
                        </div>
                    </div>
                    <div className="col-sm-6 col-md-5">
                        <div className="about-value m-bottom-12">
                            ...
                            <h5 className="m-top-3 text-primary">Mistakes are overrated</h5>
                            <p className="m-top-2">
                                Instead of only focusing on what isn’t working in order to fix it,
                                we focus on what is working well, so that we emphasize on that and
                                make it even better on the way to making it the best.
                            </p>
                        </div>
                    </div>
                </div>
