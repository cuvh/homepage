	...
	return (
		<div className="pricing-benefits">
			<div className="container">
				<div
				 className="m-bottom-10 basic-benefits"
				 style={{ display: "none" }}
				>
					...
					<div className="Grid Grid--alignCenter">
						<div className="Grid Grid-cell--sm-5 Grid-cell--md-4 m-bottom-5 Grid-cell--sm-offset-1 Grid-cell--md-offset-2 animate-in">
							...
							<div className="Grid-cell--xs-10 benefits-padding">
								...
								<div className="pricing-benefits-description">
									Make unlimited changes and download the
									resume as many times as you want.
								</div>
							</div>
						</div>
						...
						<div className="Grid Grid-cell--sm-5 Grid-cell--md-4 m-bottom-5 animate-in">
							<div className="Grid-cell--xs-2 pricing-icon">
								<img src="/img/pricing/icon_entries.svg" />
							</div>
							<div className="Grid-cell--xs-10 benefits-padding">
								<div className="pricing-benefits-title">
									Up to 15 entries
								...
								<div className="pricing-benefits-description">
									Show the most relevant points of your
					...
					<div className="Grid Grid--alignCenter">
						<div className="Grid Grid-cell--sm-5 Grid-cell--md-4 m-bottom-5 Grid-cell--sm-offset-1 Grid-cell--md-offset-2 animate-in">
							...
							<div className="Grid-cell--xs-10 benefits-padding">
								...
								<div className="pricing-benefits-description">
									Add the key information about you, like
						...
						<div className="Grid Grid-cell--sm-5 Grid-cell--md-4 m-bottom-5 animate-in">
							...
							<div className="Grid-cell--xs-10 benefits-padding">
								...
								<div className="pricing-benefits-description">
									Customize colors, fonts, and icons and make
									sure your resume is never bland.
								</div>
							</div>
						</div>
					</div>
					...
					<div className="Grid Grid--alignCenter">
						<div className="Grid Grid-cell--sm-5 Grid-cell--md-4 m-bottom-5 Grid-cell--sm-offset-1 Grid-cell--md-offset-2 animate-in pricing-locked">
							...
							<div className="Grid-cell--xs-10 benefits-padding">
								...
								<div className="pricing-benefits-description">
									Get the full credit for your resume by
									removing the Enhancv logo on the page.
								</div>
							</div>
						</div>
						...
						<div className="Grid Grid-cell--sm-5 Grid-cell--md-4 m-bottom-5 animate-in pricing-locked">
							...
							<div className="Grid-cell--xs-10 benefits-padding">
								...
								<div className="pricing-benefits-description">
									Use a visually appealing layout that fits
					...
					>
						<h5>
							Get up to 10 resumes, unlimited entries and Pro
							sections
						</h5>
					...
					<div className="Grid Grid--alignCenter">
						<div className="Grid Grid-cell--sm-5 Grid-cell--md-4 m-bottom-5 Grid-cell--sm-offset-1 Grid-cell--md-offset-2 animate-in">
							...
							<div className="Grid-cell--xs-10 benefits-padding">
								...
								<div className="pricing-benefits-description">
									Make changes to your resume and tailor to a
									specific position in a matter of minutes.
								</div>
							</div>
						</div>
						...
						<div className="Grid Grid-cell--sm-5 Grid-cell--md-4 m-bottom-5 animate-in">
							...
							<div className="Grid-cell--xs-10 benefits-padding">
								...
								<div className="pricing-benefits-description">
									Add more of your personal and professional
									experience to prove your culture fit.
								</div>
							</div>
						</div>
					</div>
					...
					<div className="Grid Grid--alignCenter">
						<div className="Grid Grid-cell--sm-5 Grid-cell--md-4 m-bottom-5 Grid-cell--sm-offset-1 Grid-cell--md-offset-2 animate-in">
							...
							<div className="Grid-cell--xs-10 benefits-padding">
								...
								<div className="pricing-benefits-description">
									Show certificates, awards, references, and
									more, so that your achievements come across.
								</div>
							</div>
						</div>
