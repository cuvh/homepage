...
import zainabLogo from "assets/img/new-homepage/testimonials/zainab@2x.png";
import edwardLogo from "assets/img/new-homepage/testimonials/edward@2x.png";
import claraLogo from "assets/img/new-homepage/testimonials/clara@2x.png";
                        ...
                        >
                            ...
                            <div className="Grid testimonial-valign Grid-cell--xs-12 Grid-cell--sm-6 Grid-cell--sm-offset-1 Grid-cell--lg-offset-1">
                                <div className="m-left-1 text-center-xs">
                                    ...
                                    <h3 className="m-top-no hidden-lg">
                                        “{text}”
                                    </h3>
                                    <p className="text-muted m-top-2 text-small">
                                        {title}
                                    </p>
                                </div>
                            </div>
