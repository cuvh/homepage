...
export default function BooksThree() {
    return (
        <section className="component--books m-sm-top-5 m-md-top-10 m-md-bottom-5 text-center">
            <div className="container">
                <h3 className="h3">Books that formed his life 3 books</h3>
