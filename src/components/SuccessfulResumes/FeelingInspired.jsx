...
export default class FeelingInspired extends React.PureComponent {
    ...
    render() {
        ...
        return (
            <div
             className={classnames("component--feeling m-md-top-13 m-sm-top-4 m-sm-right-2", {
                ...
                <span
                 ...
                 className={classnames("component--feeling-emotion emotion-neutral", {
                    active: emotion === "neutral",
                 })}
                />
                <span
                 onClick={() => this.onClick("smilling")}
                 className={classnames("component--feeling-emotion emotion-smiling", {
                    active: emotion === "smilling",
                 })}
                />
                <span
                 onClick={() => this.onClick("happy")}
                 className={classnames("component--feeling-emotion emotion-happy", {
