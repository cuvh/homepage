            ...
            <div className="member center-block bottom-md">
                ...
                >
                    <div className="member-text">
                        <p className="member-title bottom-xs">
                            {this.props.name}
                        </p>
                ...
                <Modal isModalShowed={this.state.isModalShowed}>
                    {" "}
                    <div
                     id={`${this.props.id}`}
                        ...
                        <div className="modal-content">
                            ...
                            <div className="modal-body">
                                ...
                                <div className="top-sm">
                                    {this.props.pdf ? (
                                        <a
                                         href={`/img/about/member/${this.props
                                            .pdf}`}
                                    ...
                                    {this.props.linkedin ? (
                                        <a
                                         href={`https://www.linkedin.com/in/${this
                                            .props.linkedin}`}
                                         className="btn btn-link btn-member-icon"
                                         target="_blank"
                                        >
                                    ...
                                    {this.props.medium ? (
                                        <a
                                         href={`https://medium.com/@${this.props
                                            .medium}`}
                                         className="btn btn-link btn-member-icon"
                                         target="_blank"
                                        >
                                    ...
                                    {this.props.dribbble ? (
                                        <a
                                         href={`https://dribbble.com/${this.props
                                            .dribbble}`}
                                         className="btn btn-link btn-member-icon"
                                         target="_blank"
                                        >
                                    ...
                                    {this.props.github ? (
                                        <a
                                         href={`https://github.com/${this.props
                                            .github}`}
                                         className="btn btn-link btn-member-icon"
                                         target="_blank"
                                        >
                                    ...
                                    {this.props.twitter ? (
                                        <a
                                         href={`https://twitter.com/${this.props
                                            .twitter}`}
                                         className="btn btn-link btn-member-icon"
                                         target="_blank"
                                        >
                                    ...
                                    {this.props.facebook ? (
                                        <a
                                         href={`https://facebook.com/${this.props
                                            .facebook}`}
                                         className="btn btn-link btn-member-icon"
                                         target="_blank"
                                        >
