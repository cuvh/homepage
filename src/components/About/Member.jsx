			...
			<div className="member center-block bottom-md">
				...
				<Modal modalShowed={this.state.modalShowed}>
					<div
					 tabIndex="-1"
					 className={
						this.state.modalShowed ? "modal in" : "modal fade"
					 }
					>
						<div
						 id={`${this.props.id}`}
