						...
						<div className="Grid Grid--alignCenter">
							...
							<div className="Grid Grid-cell--sm-5 Grid-cell--md-4 m-bottom-5 animate-in">
								...
								<div className="Grid-cell--xs-10 benefits-padding">
									...
									<div className="pricing-benefits-description">
										Customize colors, fonts, and icons and
										make sure your resume is never bland.
									</div>
								</div>
							</div>
						</div>
						...
						<div className="Grid Grid--alignCenter">
							...
							<div className="Grid Grid-cell--sm-5 Grid-cell--md-4 m-bottom-5 animate-in pricing-locked">
								...
								<div className="Grid-cell--xs-10 benefits-padding">
									...
									<div className="pricing-benefits-description">
										Use a visually appealing layout that
										fits more information in one page.
									</div>
								</div>
							</div>
						</div>
						...
						<div className="Grid Grid--alignCenter">
							<div className="Grid Grid-cell--sm-5 Grid-cell--md-4 m-bottom-5 Grid-cell--sm-offset-1 Grid-cell--md-offset-2 animate-in">
								...
								<div className="Grid-cell--xs-10 benefits-padding">
									...
									<div className="pricing-benefits-description">
										Make changes to your resume and tailor
										to a specific position in a matter of
										minutes.
									</div>
								</div>
							</div>
							...
							<div className="Grid Grid-cell--sm-5 Grid-cell--md-4 m-bottom-5 animate-in">
								...
								<div className="Grid-cell--xs-10 benefits-padding">
									...
									<div className="pricing-benefits-description">
										Add more of your personal and
										professional experience to prove your
										culture fit.
									</div>
								</div>
							</div>
						...
						<div className="Grid Grid--alignCenter">
							<div className="Grid Grid-cell--sm-5 Grid-cell--md-4 m-bottom-5 Grid-cell--sm-offset-1 Grid-cell--md-offset-2 animate-in">
								...
								<div className="Grid-cell--xs-10 benefits-padding">
									...
									<div className="pricing-benefits-description">
										Show certificates, awards, references,
										and more, so that your achievements come
										across.
									</div>
								</div>
							</div>
